...
/***/ function(module, exports, __webpack_require__) {
	...
	var PhotosFrame = function (_React$Component) {
	  _inherits(PhotosFrame, _React$Component);
	
	  function PhotosFrame() {
	    _classCallCheck(this, PhotosFrame);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PhotosFrame).apply(this, arguments));
	  }
